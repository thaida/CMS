...
class CategoryController extends Controller {
	...
	*/
	...
	{
		$posts = $this->category_gestion->indexFront($this->nbrPages);
		$links = $posts->setPath('')->render();

		return view('front.category.index', compact('posts', 'links'));
	}
	...
	{
		return redirect(route('category.order', [			
			'sens' => 'asc'
		]));
...
*/
		return view('back.category.index', compact('posts', 'links', 'order'));
	...
	public function create()
	{
		...
		return view('back.category.create')->with(compact('url'));
	}
		...
		$slug)
	{
		...
		return view('back.category.index',  array("2", "1"));
	}
